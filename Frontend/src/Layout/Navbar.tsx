    ...
    <nav className="navbar z-50 w-full bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 shadow-lg backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <span className="text-2xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-purple-600 to-pink-500 drop-shadow animate-fade-in">HonestIQ</span>
        </Link>
        {/* Nav Buttons */}
