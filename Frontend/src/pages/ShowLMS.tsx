...
const MainPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 flex flex-col items-center justify-start py-20 px-2 overflow-hidden">
      <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-purple-600 to-pink-500 mb-16 drop-shadow-lg animate-fade-in overflow-hidden">All LMS</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-14 w-full max-w-5xl overflow-hidden py-5">
        {lmsList.map((lms, idx) => (
          <a
            href={lms.link}
            key={lms.name}
