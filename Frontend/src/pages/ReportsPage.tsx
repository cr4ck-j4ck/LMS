...
import { FaFileAlt, FaCheckCircle, FaExclamationTriangle, FaRegClock } from "react-icons/fa";
                ...
                {reports.map((report, idx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {report.fullReport ? (
                        <button
                          className="inline-block px-4 py-2 bg-blue-700 text-white rounded-lg font-semibold shadow hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition-colors duration-200 group-hover:scale-105"
