...
const MoodleAboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-green-100 via-blue-100 to-purple-100 relative overflow-hidden py-16 px-6">
      {/* Animated background blobs */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-green-400 to-blue-400 rounded-full opacity-30 blur-3xl animate-blob1 z-0" />
      ...
      <div className="relative z-10 flex flex-col overflow-y-hidden items-center text-center px-10 py-20 w-full">
        <div className="flex items-center gap-6 mb-12 animate-fade-in pt-10 pb-5 overflow-hidden" style={{minHeight: '90px'}}>
